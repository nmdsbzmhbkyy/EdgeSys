...
// 生成路径: temp/base/api/base_frame.go
// 生成人：aurine
// ==========================================================================
import (
...
func (p *BaseFrameApi) GetBaseFrameList(rc *restfulx.ReqCtx) {
    ...
    data.PUuid = restfulx.QueryParam(rc, "pUuid")
    data.ThirdId = restfulx.QueryParam(rc, "thirdId")
    data.EntityCode = restfulx.QueryParam(rc, "entityCode")
    data.FrameCode = restfulx.QueryParam(rc, "frameCode")
    data.EntityName = restfulx.QueryParam(rc, "entityName")
    data.FrameName = restfulx.QueryParam(rc, "frameName")
